...
import { DEMO_EMAIL, DEMO_PASSWORD, friendlyError, signIn } from "@/lib/live-market";
    ...
    <main className="grid min-h-screen place-items-center bg-slate-950 p-4 text-white">
      <section className="glass-panel w-full max-w-md rounded-xl p-6 text-slate-950">
        ...
        <form onSubmit={submit} className="mt-6 grid gap-4">
          <label className="field">Email<input name="email" type="email" required defaultValue={DEMO_EMAIL} /></label>
          <label className="field">Contrasena<input name="password" type="password" required defaultValue={DEMO_PASSWORD} /></label>
